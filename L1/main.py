...
for i in range(5, 12):
    ...
    print("for " + str(i) + " nodes:"
          + "\n\tbfs time:    {0}ms".format(round(bfs_execution_time, 1)) + "\tcost:{0} path: {1}".format(
        round(bfs_res[1], 3), bfs_res[0])
          + "\n\tdfs time:    {0}ms".format(round(dfs_execution_time, 1)) + "\tcost:{0} path: {1}".format(
        round(dfs_res[1], 3), dfs_res[0])
          + "\n\tgreedy time: {0}ms".format(round(z_execution_time, 1)) + "\tcost:{0} path: {1}".format(
